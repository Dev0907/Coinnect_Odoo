...
function ProfileSection({ user, onUpdateAvatar }) {
  ...
  return (
    <div className="profile-section">
      ...
      <Link to={'/join'} className="sidebar-button"> <p className="B">Join Community</p></Link>
      <Link to={'/create'} className="sidebar-button"><p className="B">Create Community</p></Link>
